  ...
  return (
    ...
    <h1 className={classes.marginHeader}>Projects</h1>
      <Grid container spacing={5}>
        ...
        {/* TODO use links without <a> tags */}
        <Grid data-aos='fade-right' item className={classes.textHeader} xs={12} sm={8}>
          <h2><a className={classes.projectLink} href="https://hellabyte-e404f.firebaseapp.com/">Hellabyte</a></h2>
        ...
        <Grid data-aos='fade-left' item className={classes.textHeader} xs={12} sm={8}>
          <h2><a className={classes.projectLink} href="https://github.com/Joebenitus/poser_gem">Poserbot</a></h2>
        ...
        <Grid data-aos='fade-right' item className={classes.textHeader} xs={12} sm={8}>
          <h2><a className={classes.projectLink} href="https://github.com/Joebenitus/minecraft_shop">Minecraft Shop</a></h2>
